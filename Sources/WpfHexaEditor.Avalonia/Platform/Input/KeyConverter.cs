...
namespace WpfHexaEditor.Avalonia.Platform.Input
{
    /// <summary>
    /// Converts between Avalonia Key and PlatformKey.
    /// </summary>
    public static class KeyConverter
    {
        /// <summary>
        /// Converts an Avalonia Key to PlatformKey.
        /// </summary>
        public static PlatformKey ToPlatformKey(Key key)
        {
            return key switch
            {
                ...
                // Editing (Key.Enter and Key.Return are the same in Avalonia)
        ...
        /// <summary>
        /// Converts Avalonia KeyModifiers to PlatformModifierKeys.
        /// </summary>
        public static PlatformModifierKeys ToPlatformModifiers(KeyModifiers modifiers)
        {
            ...
            if (modifiers.HasFlag(KeyModifiers.Meta)) // Meta = Windows key on Windows, Command on Mac
